...
<div class="container">
  <h2>상 품 등 록</h2>
  <form name="myform" method="post" action="<%=request.getContextPath()%>/hw/hw1115">
    ...
    <div id="addDiv">
	    ...
	    <b>수 량 : </b><input type="number" id="number1" name="number" style="width:60px; height:20px;"/>
	    <b>금 액 : </b><input type="number" id="price1" name="price" style="width:60px; height:20px;"/><br/>
    </div>
    <p>
