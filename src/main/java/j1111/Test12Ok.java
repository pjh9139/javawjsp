...
public class Test12Ok extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("이메일 : " + email+"@"+com);
        ...
        //웹에 내용을 출력하기 위해서는 PrinterWriter객체를 통해서 처리한다.
        PrintWriter out = response.getWriter();
        out.println("안녕.. 이곳은 서블릿이야....<br/>");
        out.println("성명 : " + name+"<br/>");
        out.println("나이 : " + age+"<br/>");
        out.println("성별 : " + gender+"<br/>");
        out.println("이메일 : " + email+"@"+com+"<br/>");
...
//        	out.println("history.back()");
        ...
        out.println("<p><a href='"+request.getContextPath()+"/study/1111/test12.jsp'>돌아가기</p>");
    }
